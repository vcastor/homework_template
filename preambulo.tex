...
\usepackage{etoolbox} % We first call it to not break csquotes package
...
\usepackage{tabularx} % ctable alraedy called it
\usepackage{array} % already loaded since we use ctable
\usepackage{colortbl}
\tcbuselibrary{skins}
